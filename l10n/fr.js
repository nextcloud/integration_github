OC.L10N.register(
    ...
    "GitHub issues, pull requests and comments" : "Tickets, requêtes de tirage et commentaires GitHub",
    "Comment" : "Commentaire",
    ...
    "Open draft pull request" : "Ouvrir un brouillon de requête de tirage",
    "Open pull request" : "Ouvrir une requête de tirage",
    "Merged pull request" : "Requête de tirage fusionnée",
    "Closed pull request" : "Requête de tirage fermée",
    "Unknown state" : "État inconnu",
    "Draft" : "Brouillon",
    "{logins} reacted with {emoji} emoji" : "{logins} ont réagi avec {emoji} emoji",
    "Review requested" : "Révision demandée",
    "opened {relativeDate}" : "ouvert {relativeDate}",
    "was closed {relativeDate}" : "fermé {relativeDate}",
    "was merged {relativeDate}" : "mergé {relativeDate}",
    "Comment from {login}" : "Commentaire de {login}",
    "commented {date}" : "a commenté {date}",
    "edited {date}" : "édité {date}",
