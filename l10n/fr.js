OC.L10N.register(
    ...
    "_You have %n new unread notification with recent activity on GitHub._::_You have %n new unread notifications with recent activity on GitHub._" : ["Vous avez %n nouvelle notification non lue concernant l'activité récente sur GitHub.","Vous avez %n nouvelles notifications non lues concernant l'activité récente sur GitHub.","Vous avez %n nouvelles notifications non lues concernant l'activité récente sur GitHub."],
    ...
    "If you want to allow your Nextcloud users to use OAuth to authenticate to {githubUrl}, create an OAuth application in your GitHub settings." : "Si vous voulez permettre à vos utilisateurs Nextcloud d'utiliser OAuth pour s'authentifier sur {githubUrl}, créez une application OAuth dans vos paramètres GitHub.",
    ...
    "Connected with the default access token as {user}" : "Connecté en tant que {user} avec le jeton d'accès par défaut",
    ...
    "Enable notifications for new unread GitHub notifications" : "Activer les notifications pour les notifications GitHub non lues",
    ...
    "When you create a personal access token yourself, give it at least \"read:user\", \"user:email\" and \"notifications\" permissions. To also preview private repository links, add the \"repo\" scope." : "Lorsque vous créez vous-même un jeton d'accès personnel, donnez-lui au moins les permissions « read:user », « user:email » et « notifications ». Pour également prévisualiser les liens des dépôts privés, ajoutez la portée « repo ».",
    ...
    "Connect to GitHub with OAuth" : "Connectez-vous à GitHub à l'aide d'OAuth",
