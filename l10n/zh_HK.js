OC.L10N.register(
    ...
    "If you want to allow your Nextcloud users to use OAuth to authenticate to https://github.com, create an OAuth application in your GitHub settings." : "如果您想要允許您的 Nextcloud 用戶使用 OAuth 對 https://github.com 進行身份驗證，在您的 GitHub 設定中建立 OAuth 應用程式。",
