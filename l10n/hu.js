OC.L10N.register(
    ...
    "_You have %n new unread notification with recent activity on GitHub._::_You have %n new unread notifications with recent activity on GitHub._" : ["%n új olvasatlan értesítése van a GitHubon, amelynél tevékenység volt a közelmúltban.","%n új olvasatlan értesítése van a GitHubon, amelynél tevékenység volt a közelmúltban."],
    ...
    "If you want to allow your Nextcloud users to use OAuth to authenticate to {githubUrl}, create an OAuth application in your GitHub settings." : "Ha azt szeretné, hogy a Nextcloud felhasználók OAuth használatával hitelesítsenek a {githubUrl} webhelyen, hozzon létre egy OAuth alkalmazást a GitHub beállításaiban.",
    ...
    "Connected with the default access token as {user}" : "Kapcsolódva az alapértelmezett hozzáférési tokennel mint {user}",
    ...
    "When you create a personal access token yourself, give it at least \"read:user\", \"user:email\" and \"notifications\" permissions. To also preview private repository links, add the \"repo\" scope." : "Amikor saját maga hoz létre személyes hozzáférési tokent, adjon meg neki legalább „read:user”, „user:email” és „notifications” engedélyeket. Ha a zárt tárolók linkjeit is meg szeretné tekinteni, adja hozzá a „repo” hatókört.",
