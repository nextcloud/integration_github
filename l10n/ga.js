OC.L10N.register(
    ...
    "_You have %n new unread notification with recent activity on GitHub._::_You have %n new unread notifications with recent activity on GitHub._" : ["Tá %n fógra neamhléite nua agat le gníomhaíocht le déanaí ar GitHub.","Tá %n fógraí neamhléite nua agat le gníomhaíocht le déanaí ar GitHub.","Tá %n fógraí neamhléite nua agat le gníomhaíocht le déanaí ar GitHub.","Tá %n fógraí neamhléite nua agat le gníomhaíocht le déanaí ar GitHub.","Tá %n fógraí neamhléite nua agat le gníomhaíocht le déanaí ar GitHub."],
    ...
    "If you want to allow your Nextcloud users to use OAuth to authenticate to {githubUrl}, create an OAuth application in your GitHub settings." : "Más mian leat ligean do d'úsáideoirí Nextcloud OAuth a úsáid chun fíordheimhniú a dhéanamh chuig {githubUrl}, cruthaigh feidhmchlár OAuth i do shocruithe GitHub.",
    ...
    "Your Nextcloud users will then see a \"Connect to GitHub\" button in their personal settings." : "Feicfidh d’úsáideoirí Nextcloud cnaipe “Ceangail le GitHub” ina socruithe pearsanta ansin.",
    ...
    "Connected with the default access token as {user}" : "Ceangailte leis an gcomhartha rochtana réamhshocraithe mar {user}",
    ...
    "Enable notifications for new unread GitHub notifications" : "Cumasaigh fógraí le haghaidh fógraí nua neamhléite GitHub",
    ...
    "You can manually provide a personal access token or connect via OAuth " : "Is féidir leat comhartha rochtana pearsanta a sholáthar de láimh nó nascadh trí OAuth",
    "When you create a personal access token yourself, give it at least \"read:user\", \"user:email\" and \"notifications\" permissions. To also preview private repository links, add the \"repo\" scope." : "Nuair a chruthaíonn tú comhartha rochtana pearsanta duit féin, tabhair ceadanna \"léigh:úsáideoir\", \"úsáideoir:ríomhphost\" agus \"fógra\" dó ar a laghad. Chun réamhamharc a dhéanamh ar naisc stórtha príobháideacha freisin, cuir an raon feidhme \"stórtha\" leis.",
    "GitHub personal access tokens" : "Comharthaí rochtana pearsanta GitHub",
    "Personal access token" : "Comhartha rochtana pearsanta",
    "Connect to GitHub with a personal token" : "Ceangail le GitHub le comhartha pearsanta",
    "Connect to GitHub with OAuth" : "Ceangail le GitHub le OAuth",
