OC.L10N.register(
    ...
    "If you want to allow your Nextcloud users to use OAuth to authenticate to {githubUrl}, create an OAuth application in your GitHub settings." : "Se quere permitir que os seus usuarios de Nextcloud usen OAuth para autenticarse en {githubUrl}, cree unha aplicación OAuth nos seus axustes de GitHub.",
    ...
    "Make sure you set the \"Authorization callback URL\" to" : "Asegúrese de definir o «URL de devolución de chamada de autorización» como",
    ...
    "Connected with the default access token as {user}" : "Conectado co testemuño predeterminado de acceso como {user}",
    ...
    "Personal access token" : "Testemuño de acceso persoal",
    "Connect to GitHub with a personal token" : "Conectar con GitHub empregando un testemuño persoal",
    "Connect to GitHub with OAuth" : "Conectar con GitHub mediante OAuth",
    ...
    "OMG! No GitHub notifications!" : "Vaites! Non hai notificacións de GitHub!",
