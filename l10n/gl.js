OC.L10N.register(
    ...
    "GitHub integration provides a dashboard widget displaying your important notifications and a unified search provider to search for repositories, issues and pull requests." : "A integración de GitHub fornece un trebello de panel que amosa as súas notificacións importantes e un provedor de busca unificado para buscar repositorios, incidencias (issues) e solicitudes de extracción (pull requests).",
    ...
    "Set \"Application name\", \"Homepage URL\" and \"Application description\" to values that will make sense to your Nextcloud users as they will see them when connecting to GitHub using your OAuth app." : "Estableza o «Nome da aplicación», «URL de inicio» e a «'Descrición da aplicación» a valores que teñán sentido para os seus usuarios do Nextcloud, xa que os verán cando se conecten a GitHub usando a súa aplicación OAuth.",
    "Make sure you set the \"Authorization callback URL\" to" : "Asegúrese de establecer o «URL de devolución de chamada de autorización» como",
    ...
    "Your Nextcloud users will then see a \"Connect to GitHub\" button in their personal settings." : "Os seus usuarios do Nextcloud verán entón un botón «Conectar co GitHub» nos seus axustes persoais.",
    "Client ID" : "ID do cliente",
    "Client ID or your GitHub application" : "ID do cliente ou a súa aplicación de GitHub",
    "Client secret" : "Segredo do cliente",
    "Client secret or your GitHub application" : "Segredo do cliente ou a súa aplicación de GitHub",
    ...
    "Connect to GitHub" : "Conectar co GitHub",
    "Connected as {user}" : "Conectado como {user}",
    "Disconnect from GitHub" : "Desconectar de GitHub",
    "Enable searching for repositories, issues and pull requests." : "Activar a busca de repositorios, incidencias (issues) e solicitudes de extracción (pull request).",
    ...
    "GitHub OAuth access token successfully retrieved!" : "Recuperouse correctamente o testemuño de acceso OAuth de GitHub.",
    ...
    "Error connecting to GitHub" : "Produciuse un erro ao conectar co GitHub",
    ...
    "You were mentioned in a pull request" : "Vostede foi mencionado nunha solicitude de extracción (Pull request)",
    "You were mentioned in an issue" : "Vostede foi mencionado nunha incidencia (issue)",
    "Comment" : "Comentario",
