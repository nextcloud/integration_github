OC.L10N.register(
    ...
    "GitHub integration provides a dashboard widget displaying your most important notifications\n    and a unified search provider for repositories, issues and pull requests." : "A integración de GitHub fornece un trebello de panel que amosa as súas notificacións\n    importantes e un provedor de busca unificado para buscar repositorios, incidencias\n    (issues) e solicitudes de extracción (pull requests).",
    ...
    "Client ID or your GitHub application" : "ID do cliente da súa aplicación de GitHub",
