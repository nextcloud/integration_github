OC.L10N.register(
    ...
    "Unknown error" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    ...
    "by {creator} was merged {relativeDate}" : "wurde am {relativeDate} von {creator} zusammengeführt",
    "opened {relativeDate} by {creator}" : "wurde am {relativeDate} von {creator} eröffnet",
    "by {creator} was closed {relativeDate}" : "wurde am {relativeDate} von {creator} geschlossen",
