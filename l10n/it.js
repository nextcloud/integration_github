OC.L10N.register(
    ...
    "More notifications" : "Altre notifiche",
    "Comment" : "Commento",
    ...
    "Default access token" : "Token di accesso predefinito",
    ...
    "GitHub personal access tokens" : "Token di accesso personali di GitHub",
    "Personal access token" : "Token di accesso personale",
    ...
    "Line {begin} to {end}" : "Dalla riga {begin} a {end}",
    "Line {line}" : "Riga {line}",
    "Unknown error" : "Errore sconosciuto",
    "Unknown state" : "Stato sconosciuto",
    "Draft" : "Bozza",
    "Comment from {login}" : "Commento da {login}",
    "Assigned to {login}" : "Assegnato a {login}",
