OC.L10N.register(
    ...
    "_You have %s new unread notification with recent activity on GitHub._::_You have %s new unread notifications with recent activity on GitHub._" : ["You have %s new unread notification with recent activity on GitHub.","You have %s new unread notifications with recent activity on GitHub."],
    ...
    "If you want to allow your Nextcloud users to use OAuth to authenticate to {githubUrl}, create an OAuth application in your GitHub settings." : "If you want to allow your Nextcloud users to use OAuth to authenticate to {githubUrl}, create an OAuth application in your GitHub settings.",
    ...
    "Connected with the default access token as {user}" : "Connected with the default access token as {user}",
    ...
    "Enable notifications for new unread GitHub notifications" : "Enable notifications for new unread GitHub notifications",
    ...
    "When you create a personal access token yourself, give it at least \"read:user\", \"user:email\" and \"notifications\" permissions. To also preview private repository links, add the \"repo\" scope." : "When you create a personal access token yourself, give it at least \"read:user\", \"user:email\" and \"notifications\" permissions. To also preview private repository links, add the \"repo\" scope.",
    ...
    "OMG! No GitHub notifications!" : "OMG! No GitHub notifications!",
